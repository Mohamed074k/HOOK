...
const FeaturedTripsSection = () => {
  ...
  // Gatekeeper Ref: يمنع الـ StrictMode من إرسال الـ Request مرتين في Network Tab
              ...
              <SwiperSlide key={`skeleton-${i}`} className="h-auto">
                <div className="flex flex-col gap-4 animate-pulse">
                  ...
                  <div className="px-2 space-y-2">
                    <div className="h-3 w-1/3 bg-[#002238] rounded" />
                    <div className="h-6 w-3/4 bg-[#002238] rounded" />
                    <div className="h-4 w-1/4 bg-[#002238] rounded" />
                  </div>
                </div>
              </SwiperSlide>
            ))
            ...
            trips.map((trip) => (
              <SwiperSlide key={trip.id} className="h-auto">
                ...
                >
                  ...
                  <div className="flex flex-col px-1 flex-1 justify-between gap-1.5">
                    <div>
                      ...
                      <h3 className="text-[#cee5ff] font-bold text-lg md:text-xl line-clamp-2 leading-tight group-hover:text-white transition-colors">
                        {trip.title}
                      </h3>
                    </div>
