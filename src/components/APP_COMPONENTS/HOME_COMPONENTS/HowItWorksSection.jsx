  ...
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-8 py-16 relative z-10">
      <motion.div
        ...
        style={{
          background: "linear-gradient(160deg, rgba(0,34,56,0.95) 0%, rgba(0,21,38,0.95) 100%)",
        }}
      >
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-6">
            {steps.map((step) => (
              ...
              >
                <div className="w-16 h-16 rounded-full bg-[#001526] border border-[#243649] flex items-center justify-center mb-6 relative z-10 group-hover:border-sky-400/50 transition-all duration-300">
