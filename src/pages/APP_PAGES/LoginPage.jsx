...
//         "Login failed. Please check your credentials.";
//       toast.error(msg, {
//         style: { background: "#002238", color: "#cee5ff", border: "1px solid rgba(239,68,68,0.2)" }
//       });
//     } finally {
//       setIsLoading(false);
//     }
...
//       }}
//     >
//       {/* Overlays - FIXED: Top-to-Bottom Shadow restored! */}
//       <div className="absolute inset-0 pointer-events-none">
//         <div className="absolute inset-0 bg-gradient-to-b from-[#000F1F] via-[#000F1F]/85 via-50% to-transparent" />
//       </div>

//       {/* Static ambient glow matching the new theme */}
//       <div
//         className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[500px] rounded-full pointer-events-none"
//         style={{
//           background:
...
//               src="/images/HOOK.png" 
//               alt="HOOK Logo" 
//               className="h-20 w-auto md:h-22 object-cover drop-shadow-[0_0_15px_rgba(56,189,248,0.3)]"
//             />
//           </Link>
//         </motion.div>

//         {/* Card using your #002238 matching theme */}
//         <motion.div
//           className="w-full bg-[#002238]/95 border border-white/5 rounded-2xl p-6 backdrop-blur-xl shadow-2xl"
//           variants={cardVariants}
//         >
//           <motion.div className="text-center mb-6" variants={itemVariants}>
//             <h1 className="text-2xl font-bold text-[#cee5ff] mb-1.5">
//               Welcome back
//             </h1>
//             <p className="text-[#a3cbf2]/60 text-xs">
//               Enter your credentials to access your account
//             </p>
//           </motion.div>

//           <form className="space-y-4" onSubmit={handleSubmit}>
//             {/* Email - FIXED: Now using bg-white/5 to match Booking Page */}
//             <motion.div className="relative w-full" variants={itemVariants}>
//               <input
//                 type="email"
//                 id="email"
//                 value={email}
//                 onChange={(e) => setEmail(e.target.value)}
//                 className="peer w-full bg-white/5 text-[#cee5ff] border border-white/5 rounded-xl pl-10 pr-3.5 pt-5 pb-2 text-sm focus:outline-none transition-all duration-300 placeholder-transparent hover:border-white/10"
//                 style={{
//                   boxShadow:
//                     focusedField === "email"
//                       ? "0 0 0 1px rgba(56,189,248,0.3), inset 0 1px 0 rgba(255,255,255,0.05)"
//                       : "none",
//                   borderColor: focusedField === "email" ? "#38bdf8" : undefined,
//                 }}
//                 placeholder="Email"
//                 onFocus={() => setFocusedField("email")}
//                 onBlur={() => setFocusedField(null)}
...
//               <motion.label
//                 htmlFor="email"
//                 className="absolute left-10 pointer-events-none font-bold tracking-wider uppercase"
//                 animate={{
//                   top: focusedField === "email" || email ? "8px" : "14px",
//                   fontSize: focusedField === "email" || email ? "9px" : "11px",
//                   color: focusedField === "email" ? "#38bdf8" : "rgba(163,203,242,0.5)",
//                 }}
//                 transition={{ duration: 0.22, ease }}
//               >
//                 Email Address
...
//               <motion.div
//                 className="absolute left-3 top-1/2 -translate-y-1/2"
//                 animate={{ color: focusedField === "email" ? "#38bdf8" : "rgba(163,203,242,0.4)" }}
//                 transition={{ duration: 0.2 }}
//               >
//                 <Mail size={15} />
//               </motion.div>
...
//             {/* Password - FIXED: Now using bg-white/5 to match Booking Page */}
//             <motion.div className="relative w-full" variants={itemVariants}>
//               {/* Forgot password */}
//               <motion.div
...
//                 <Link
//                   to="/forgot-password"
//                   className="text-[10px] text-[#a3cbf2]/60 font-bold tracking-wider uppercase hover:text-sky-400 transition-colors"
//                 >
//                   Forgot password?
//                 </Link>
//               </motion.div>
...
//                   value={password}
//                   onChange={(e) => setPassword(e.target.value)}
//                   className="peer w-full bg-white/5 text-[#cee5ff] border border-white/5 rounded-xl pl-10 pr-10 pt-5 pb-2 text-sm focus:outline-none transition-all duration-300 placeholder-transparent tracking-widest hover:border-white/10"
//                   style={{
//                     boxShadow:
//                       focusedField === "password"
//                         ? "0 0 0 1px rgba(56,189,248,0.3), inset 0 1px 0 rgba(255,255,255,0.05)"
//                         : "none",
//                     borderColor:
//                       focusedField === "password" ? "#38bdf8" : undefined,
//                   }}
//                   placeholder="Password"
//                   onFocus={() => setFocusedField("password")}
//                   onBlur={() => setFocusedField(null)}
...
//                   className="absolute left-10 pointer-events-none font-bold tracking-wider uppercase"
//                   animate={{
//                     top: focusedField === "password" || password ? "8px" : "14px",
//                     fontSize: focusedField === "password" || password ? "9px" : "11px",
//                     color: focusedField === "password" ? "#38bdf8" : "rgba(163,203,242,0.5)",
//                   }}
//                   transition={{ duration: 0.22, ease }}
//                 >
//                   Password
...
//                   className="absolute left-3 top-1/2 -translate-y-1/2"
//                   animate={{
//                     color: focusedField === "password" ? "#38bdf8" : "rgba(163,203,242,0.4)",
//                   }}
//                   transition={{ duration: 0.2 }}
//                 >
//                   <Lock size={15} />
...
//             {/* Submit Button matched to new Booking style */}
//             <motion.button
//               type="submit"
//               disabled={isLoading}
//               className="w-full py-3.5 rounded-xl font-bold tracking-wider text-xs flex items-center justify-center gap-2 uppercase mt-4 text-white relative overflow-hidden disabled:opacity-70 disabled:cursor-not-allowed bg-gradient-to-r from-sky-500 to-cyan-600 shadow-[0_0_20px_rgba(56,189,248,0.2)]"
//               variants={itemVariants}
//               whileHover={
//                 !isLoading
//                   ? {
...
//           {/* Register link */}
//           <motion.p
//             className="text-center text-[#a3cbf2]/60 text-[11px] mt-6 font-medium"
//             variants={itemVariants}
//           >
//             Don't have an account?{" "}
//             <MotionLink to="/register">Sign up</MotionLink>
...
// // Updated MotionLink to use sky-400
// const MotionLink = ({ children, to, muted }) => (
//   <motion.span
//     whileHover={{
//       color: muted ? "rgba(163,203,242,0.8)" : "#38bdf8", // hover: text-sky-400
//       y: muted ? -1 : 0,
//       textShadow: muted ? "none" : "0 0 10px rgba(56,189,248,0.4)",
//     }}
//     transition={{ duration: 0.2 }}
//     style={{
//       color: muted ? "inherit" : "#38bdf8", // base: text-sky-400
//       display: "inline-block",
//       cursor: "pointer",
//       fontWeight: "bold",
//     }}
